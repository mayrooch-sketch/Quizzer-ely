...
Cohesion: 0.08
Nodes (34): react, TELAS, useTrechos(), AssociationScreen(), CORES, embaralharEstavel(), Ligacao, ClozeScreen() (+26 more)

### Community 2 - "DinamicoScreen.tsx"
Cohesion: 0.07
Nodes (41): useKnows(), src_jogos_competitivo_dinamico, DinamicoScreen(), julgar(), proximaRodada(), rolar(), sortearItem(), tirarDaFila() (+33 more)

### Community 3 - "package.json"
Cohesion: 0.05
Nodes (36): dependencies, react, react-dom, react-router-dom, zustand, devDependencies, oxlint, @types/node (+28 more)

### Community 4 - "AnagramaScreen.tsx"
Cohesion: 0.14
Nodes (14): vitest, revelarNoAnagrama(), AnagramaScreen(), Rodada(), pedirAjuda(), embaralhar(), embaralharLetras(), useFilaDePalavras() (+6 more)
...
Cohesion: 0.11
Nodes (22): Ao publicar uma versão nova, Como o código está organizado, Desenvolver, Funciona sem internet, O banco de perguntas, Quizzer, Subir no Netlify, react-router-dom (+14 more)
...
Cohesion: 0.20
Nodes (11): CruzadasScreen(), PropsTabuleiro, Cruzada, EntradaCruzada, src_jogos_palavras_palavras, BingoScreen(), extrairPalavras(), letrasDaResposta() (+3 more)

### Community 16 - "PalavraDoBanco"
Cohesion: 0.18
Nodes (16): PropsRodada, Colocada, OpcoesCaca, cabe(), Casa, cruzar(), Direcao, embaralhar() (+8 more)

### Community 17 - "MemoriaScreen.tsx"
Cohesion: 0.27
Nodes (10): Carta, embaralhar(), gravarRecorde(), lerRecorde(), MemoriaScreen(), Mesa(), virar(), montarCartas() (+2 more)
...
Cohesion: 0.29
Nodes (7): Cartela(), Chamada, embaralhar(), espalhar(), LINHAS, montarPartida(), Partida
...
Cohesion: 0.29
Nodes (6): Banco publicado, Correções e verificação por jogo, Melhorias que ainda merecem uma próxima etapa, Revisão de layout, Revisão dos jogos — 23/09/2026, Verificação automatizada
...
## Knowledge Gaps
- **166 isolated node(s):** `$schema`, `plugins`, `react/rules-of-hooks`, `react/only-export-components`, `name` (+161 more)
...
- **Why does `react` connect `routes.tsx` to `DinamicoScreen.tsx`, `package.json`, `AnagramaScreen.tsx`, `games.ts`, `biblioteca.ts`, `ContraRelogioScreen.tsx`, `poco.ts`, `MemoriaScreen.tsx`, `CacaPalavrasScreen.tsx`, `BingoScreen.tsx`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `Tabuleiro()` connect `Tabuleiro` to `PalavraDoBanco`, `MemoriaScreen.tsx`, `poco.ts`?**
...
- **Should `AnagramaScreen.tsx` be split into smaller, more focused modules?**
